...
main_url = "https://www.cartoonnetwork.co.uk/"
m3u_file = "cartoonnetwork.m3u"
    ...
    with open(m3u_file, "w", encoding="utf-8") as f:
        ...
        for show in data:
            for ep in show["episodes"]:
                # EXTFINF formatı
                line = f'#EXTINF:-1 tvg-id="vod.tr" tvg-name="TR: {ep["name"]}" tvg-logo="{ep["img"]}" group-title="CartoonNetwork",TR: {ep["name"]}\n{ep["stream_url"]}\n'
                f.write(line)
...
def main(start=0, end=0):
    ...
    with open("www-cartoonnetwork-com-tr.json", "w+", encoding='utf-8') as f:
